...
public class HomeController extends Controller {
    ...
    public Result addProductSubmit() {
        ...
        flash("success", "Product " + newProduct.getName() + " has been created/uploaded " + saveImageMsg);
    ...
    public String saveFile(Long id, FilePart<File> uploaded) {
        ...
        if(uploaded != null) {
            ...
            if(mimeType.startsWith("image/")) {
                ...
                // create another ImageMagick operation and repeat the process above to
                ...
                // we must make sure the directory for the image exists before we save it
                File dir = new File("public/images/productImages");
                if(!dir.exists()) {
                    dir.mkdirs();
                }
                // now we make an ImageMagick command and execute the operations
